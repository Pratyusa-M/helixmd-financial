    ...
    server: {
      ...
      headers: {
        ...
        'Content-Security-Policy': [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://kfvmkdxnevfognngesrf.supabase.co https://cdn.plaid.com",
          "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
          "font-src 'self' https://fonts.gstatic.com data:",
          "img-src 'self' data: blob: https: http:",
          "connect-src 'self' https://kfvmkdxnevfognngesrf.supabase.co wss://kfvmkdxnevfognngesrf.supabase.co https://api.supabase.co https://*.plaid.com https://rqqliszxnoraztbcnncw.supabase.co/functions/v1",
          // Allow iframe embedding in development for Lovable preview
