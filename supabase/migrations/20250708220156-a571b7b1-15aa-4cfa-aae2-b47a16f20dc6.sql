...
-- 6. Update transactions table to use the new ENUMs
...
-- 9. Make expense_type NOT NULL and set default
ALTER TABLE public.transactions 
ALTER COLUMN expense_type SET NOT NULL,
ALTER COLUMN expense_type SET DEFAULT 'personal'::public.expense_type;

-- 10. Create a function to validate category-subcategory relationships
...
-- 11. Create trigger to enforce the validation
