...
CREATE TYPE IF NOT EXISTS public.transaction_direction AS ENUM ('credit', 'debit');
CREATE TYPE IF NOT EXISTS public.transaction_category AS ENUM ('business_income', 'other_income');
