...
-- Change owner to postgres for privileged access
ALTER FUNCTION public.floor_to_minute(timestamptz) OWNER TO postgres;
...
-- Change owner to postgres for privileged access
ALTER FUNCTION public.rate_limit_check(uuid, text, int) OWNER TO postgres;